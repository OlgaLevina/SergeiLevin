...
namespace SergeiLevin0.Services
{
    public static class TestData
    {
        ...
        public static IEnumerable<Category> Categories { get; } = new Category[]
        {
            new Category {Id = 1, Name = "Sportswear",  Order = 0, ParentId = null},
        ...
        public static IEnumerable<Product> Products { get; } = new Product[]
        {
            ...
            new Product(){Id = 6,Name = "Easy Polo Black Edition",Price = 1025,ImageUrl = "product6.jpg",Order = 5,CategoryId = 2,BrandId = 2},
            new Product(){Id = 7,Name = "Easy Polo Black Edition",Price = 1025,ImageUrl = "product7.jpg",Order = 6,CategoryId = 2,BrandId = 2},
            new Product(){Id = 8,Name = "Easy Polo Black Edition",Price = 1025,ImageUrl = "product8.jpg",Order = 7,CategoryId = 25,BrandId = 2},
            new Product(){Id = 9,Name = "Easy Polo Black Edition",Price = 1025,ImageUrl = "product9.jpg",Order = 8,CategoryId = 25,BrandId = 2},
