    ...
    public class CartControllerTests
    {
        ...
        public void CheckOut_Calls_Service_and_Return_Redirect()
        {
            ...
            cart_service_mock
               ...
               {Items = new Dictionary<ProductViewModel, int>{{ new ProductViewModel(), 1 }}});
            ...
            var user = new ClaimsPrincipal(new ClaimsIdentity(new[] { new Claim(ClaimTypes.NameIdentifier, "1") }));//создаем тестового пользователя
            var controller = new CartController(cart_service_mock.Object)
            {
